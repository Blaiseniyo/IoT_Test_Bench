...
export const ConnectionForm = () => {
	...
	const testSubscriber = () => {
		dispatch(testSubscriberAction(ref.current.values));
	};
	const testPublisher = () => {
		dispatch(testPublisherAction(ref.current.values));
	};
